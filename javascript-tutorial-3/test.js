...
// /* 100 under price */
// const product0 = products.filter(product=>product.price < 100);
// console.log(product0)


/* 50 To 60 and  90 To 100 under price */
// const product = products.filter(product => product.price >= 50 && product.price <= 60 || product.price >= 90 && product.price <= 100);  
// console.log(product)


/*High and low price*/
// const product1 = products.slice().sort((a, b) => b.price - a.price);
// console.log(product1);

/*Ex 2*/
const Price = 50;

const lowprice = products.filter(product => product.price < Price);
const highprice = products.filter(product => product.price > Price);
